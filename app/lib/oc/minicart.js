...
function minicart() {
    ...
    function template(){
        return [
            '<style>',
            '.minicart { padding: 15px 15px 15px 0; float: right; cursor: pointer;color: #000000; min-width:180px; text-align:right;}',
            ...
            '.minicart .minicart-detail {display: none;min-width: 300px;border-radius: 4px;-webkit-box-shadow: 0px 6px 12px 0px rgba(0, 0, 0, 0.176);box-shadow: 0px 6px 12px 0px rgba(0, 0, 0, 0.176);padding: 10px;position: absolute;top: 100%;right: 10px;background-color: #fff;z-index: 20;}',
